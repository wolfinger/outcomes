# -*- coding: utf-8 -*-
"""
**outcomes** - generate more robust investment data analytics
=============================================================

two primary uses for this python module:
...
creator:
    ...
    greg@wolfinger.io | https://github.com/wolfinger
...
notes:
    ...
    first release, yeey...break this and send me feedback pls!

    TODO: turn time periods and data structure into classes
    TODO: allow for dynamically choosing which measures to calc
    TODO: allow for passing in compound or log returns
    TODO: logically structure everything; kinda a hack job right now
    TODO: build the drawdown algo using my brain instead of brute force
    TODO: documentation

    TODO: future release
    ====================
    TODO: annualize and de-annualize functions
    TODO: create a total return index generator from cash flow streams
"""
...
def valid_period(period):
    ...
    i.e., that it matches the periodicity of the time series
    """
...
def excess_return(topic_ret, market_ret):
    """
    calculates the excess returns of a topic return stream vs. a market
    return stream
    """
...
def vol_skew(vol_upside, vol_downside):
    ...
    use std dev not variance unlike some defs
    """
...
def mod_treynor(topic_ret, rf_ret, mkt_vol):
    ...
    although we classify it as part of the excess return metric suite,
    it requires a benchmark return series to define what "the market" is
    """
...
def m2(topic_ret, topic_vol, sharpe, mkt_vol, cum=False, annual_factor=1):
    ...
    takes sharpe and makes it a return
    """
